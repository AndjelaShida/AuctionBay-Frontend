...
const AuctionAddedBid: React.FC = () => {
  return (
    <Wrapper>
      <Navbar>
        <NavbarContent>
      ...
      <Content>
        <Inner>
          ...
          <RightSide>
            ...
            <BiddingHistory>
              <Title2>Bidding History(3)</Title2>

              <Table>
                <TableRow>
                  <Avatar src="/images/profile.png" alt="profilepic"></Avatar>
                  <Name>Jamal Races</Name>
...
export default AuctionAddedBid;
