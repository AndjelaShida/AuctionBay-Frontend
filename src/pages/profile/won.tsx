...
import { ButtonGroup, CardsGrid, Content, LeftNavigation, Navbar, NavButton, NavButton2, NavigationTab, RightNavigation, TabBar, TitleBar, Wrapper } from "./myAuction.style";
